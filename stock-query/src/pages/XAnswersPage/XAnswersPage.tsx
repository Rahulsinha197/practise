...
import styles from "./XAnswersPage.module.scss";
import sharedStyles from "../../assets/styles/XSharedStyles.module.scss";

export interface XAnswersPagePropsInterface extends RouteComponentProps {}

export interface XAnswersPageStateInterface {
  answers: any[];
  isEmpty: boolean;
  isError: boolean;
  isLoading: boolean;
...
export interface XAnswersPageSearchParams {
  id?: string | undefined;
}

class XAnswersPage extends React.Component<
  XAnswersPagePropsInterface,
  XAnswersPageStateInterface
> {
  questionId: string = "";
  requestUrl: string = "";
  requestParams: any = {};
  ...
  constructor(props: XAnswersPagePropsInterface) {
    super(props);
    this.state = {
      answers: [],
      isEmpty: false,
  ...
  getQuestionId() {
    let id: string = "";
    let params: XAnswersPageSearchParams;
